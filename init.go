...
func DefaultQueue() Queen {
	return Queen{
		Pika: Pika{
			Addrs:    []string{"127.0.0.1:9221"},
			Password: "123456",
		},
		Mine: Mine{
			Copies:                         3,
			BlockSize:                      1024 * 1024,
			BlockPrice:                     "1000",
			PushRandomBlockIntervalSeconds: 60,
			InspectionEnabled:              false,
		},
		Chain: Chain{
			Endpoint:                  "https://data-seed-prebsc-1-s1.binance.org:8545",
			ChequebookFactoryContract: "0x9f60cd9a9faddf14babf2ff27377341afa2c87b7",
			LockerContract:            "0xa6770b3ecdb18ab7cdc610ca98d622a605b9bc2a",
			IssuerContract:            "0xe1eb17d49ad779012e12678fbce82199d65e4f17",
			IssuerCronEnabled:         false,
			IssuerCronIntervalSeconds: 60,
		},
	}
}
